...
export default defineAppConfig({
  ui: {
      ...
      compoundVariants: [
        {
          ...
          variant: 'solid',
          class:
            'bg-te-orange text-te-black border border-amber-500 hover:shadow-te-button-hover active:shadow-te-pressed active:translate-y-px',
        },
        {
          color: 'neutral',
          variant: 'solid',
          class:
            'bg-te-light text-te-black border border-te-silver hover:bg-te-off-white active:shadow-te-pressed active:translate-y-px',
        },
      ],
    },
    card: {
    ...
    badge: {
      ...
      compoundVariants: [{ color: 'primary', variant: 'solid', class: 'bg-te-orange text-te-black border-amber-500' }],
    },
  },
})
```
